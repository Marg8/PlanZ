import 'dart:io';
import 'package:planz/Admin/adminShifOrders1.dart';
import 'package:planz/Admin/updateItems.dart';
...
import 'package:planz/Widgets/searchBox.dart';
...
class _UploadPageState extends State<UploadPage>
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Route route =
                MaterialPageRoute(builder: (c) => AdminShiftOrders1());
      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(
              pinned: true, delegate: SearchBoxDelegateAdmin()),
  ...
  capturePhotoWithCamera() async {
    Navigator.pop(context);
    final imageFile = await pickerImg.getImage(
...
Widget sourceInfoAdmin(ItemModel model, BuildContext context,
  ...
  return InkWell(
    onTap: () {
      Route route =
          MaterialPageRoute(builder: (c) => UpdatePage(itemModel: model));
      Navigator.push(context, route);
    },
